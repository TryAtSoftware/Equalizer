...
/// <summary>
/// A "value template" interconnected with the `greater than or equal to a value` logical function.
/// </summary>
...
{
    /// <summary>
    /// Gets the principal value for the subsequently executed comparison. The equality will be validated only if the `actual` value is greater than or equal to this one.
    /// </summary>
