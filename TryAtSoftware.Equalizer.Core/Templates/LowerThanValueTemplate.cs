...
/// <summary>
/// A "value template" interconnected with the `lower than a value` logical function.
/// </summary>
...
{
    /// <summary>
    /// Gets the principal value for the subsequently executed comparison. The equality will be validated only if the `actual` value is lower than this one.
    /// </summary>
